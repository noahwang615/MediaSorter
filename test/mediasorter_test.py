...
SOURCE_DIR = os.path.join(PROJECT_BASE, "mediadump")
IMAGE_TARGET_DIR = os.path.join(PROJECT_BASE, "test", "image_dest")
VIDEO_TARGET_DIR = os.path.join(PROJECT_BASE, "test", "video_dest")
